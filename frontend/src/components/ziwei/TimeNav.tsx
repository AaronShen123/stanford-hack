...
import { STEMS, SI_HUA_TABLE } from '../../ziwei/constants';
import { tStar, tSiHua } from '../../ziwei/i18n';
  ...
  return (
    <div className="mb-3">
      ...
      >
        ...
        >
          {currentDx ? `Decade ${currentDx.startAge}–${currentDx.endAge}` : 'Decade'}
        </TabButton>
      ...
      {overlayInfo && (
        ...
        >
          <span className="text-[9px]" style={{ color: 'var(--t-faint)' }}>
            {view === 'daxian' ? 'Decade' : `${liunianYear}`} four transformations:
          </span>
