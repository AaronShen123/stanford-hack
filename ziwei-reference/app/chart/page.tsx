  ...
  if (!chart) {
    return (
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '48px 20px' }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8 }}>Zi Wei Dou Shu — Chart Calculator</h1>
        <p style={{ color: '#888', marginBottom: 32, fontSize: 14, lineHeight: 1.7 }}>
          Enter your birth date and time — the chart engine casts your natal chart instantly.
          <br />
          (Purple Star Astrology / 紫微斗數. All star positions and four transformations are computed at runtime.)
        </p>
